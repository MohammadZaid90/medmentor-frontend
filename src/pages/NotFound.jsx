...
//         `}
//       </style>
//       <main className="h-screen w-screen bg-white flex flex-col justify-center items-center font-sans p-4">
//         {/* SVG container for responsive scaling */}
//         <div className="w-full max-w-xl">
//           <svg
//             viewBox="0 0 541.17206 328.45184"
//             className="w-full h-auto" // SVG scales with its container
//             id="svg2"
//             version="1.1"
//           >
...
//               <g
//                 id="g6219"
//                 // Apply the animation and transform origin
//                 className="animate-an1"
//                 style={{ transformOrigin: "85px 4px" }}
//               >
//                 <path
...
//           </svg>
//         </div>
//         <p className="text-2xl my-4 text-gray-800">O-o-oh! Something broke.</p>
//         <a
//           id="errorLink"
//           onClick={() => navigate(-1)}
//           className="text-xl p-3 border border-solid border-black text-black bg-transparent no-underline transition-all duration-500 ease-in-out hover:text-white active:text-white hover:bg-black active:bg-black rounded-lg shadow-sm hover:shadow-md"
//         >
//           Go Back
//         </a>
//       </main>
  ...
  return (
    <>
      ...
      <main className="h-screen w-screen bg-white flex flex-col justify-center items-center font-sans p-4">
        ...
        <div className="w-full max-w-xl">
          ...
          >
            ...
            <defs id="defs6">
              ...
              >
                <rect
                  style={{ fill: "#1d4ed8", stroke: "none" }} // Changed from black
                  x="0"
                  y="-0.5"
                  width="1"
                  height="2"
              ...
              <linearGradient osb:paint="solid" id="linearGradient6096">
                <stop
                  id="stop6094"
                  offset="0"
                  style={{ stopColor: "#1d4ed8", stopOpacity: 1 }} // Changed from #000000
                />
              </linearGradient>
            </defs>
            <g transform="translate(170.14515,0.038164)" id="layer1">
              ...
              >
                <path
                  ...
                  style={{
                    display: "inline",
                    fill: "#1d4ed8", // Changed from #000000
                    fillOpacity: 1,
                    stroke: "#1d4ed8", // Changed from #000000
                    strokeWidth: "0.1px",
                    strokeLinecap: "butt",
                    strokeLinejoin: "miter",
                    strokeOpacity: 1,
                ...
                <g id="g6174">
                  ...
                  <path
                    ...
                    style={{
                      fill: "none",
                      stroke: "#1d4ed8", // Changed from black
                      strokeWidth: "1px",
                      strokeLinecap: "butt",
                      strokeLinejoin: "miter",
                      strokeOpacity: 1,
                  ...
                  <path
                    ...
                    d="m 187.2662,239.00256 c 0.76634,-0.82482 2.12163,-2.00333 3.50552,-2.26818 1.38389,-0.26485 2.79921,0.38383 3.2412,1.53192 0.442,1.14808 -0.0885,2.79852 -1.5624,3.24089 -1.4739,0.44236 -3.88809,-0.32312 -3.7995,0.001 0.0886,0.32427 2.68064,1.73812 4.00626,3.12221 1.32563,1.38408 1.38456,2.73956 0.79537,3.38822 -0.5892,0.64866 -1.82576,0.58977 -2.53349,0.11762 -0.70773,-0.47215 -0.88437,-1.35536 -1.59092,-2.65068 -0.70656,-1.29532 -1.94507,-3.00565 -2.47512,-4.09626 -0.53005,-1.09062 -0.35326,-1.56206 0.41308,-2.38689 z"
                    style={{
                      fill: "#1d4ed8", // Changed from black
                      fillOpacity: 1,
                      stroke: "#1d4ed8", // Changed from black
                      strokeWidth: "1px",
                      strokeLinecap: "butt",
        ...
        <p className="text-2xl my-4 text-blue-700">
          {" "}
          {/* Changed from text-gray-800 */}
          O-o-oh! Something broke.
        </p>
        <a
          id="errorLink"
          onClick={() => navigate(-1)}
          className="text-xl p-3 border cursor-pointer border-solid border-blue-700 text-blue-700 bg-transparent no-underline transition-all duration-500 ease-in-out hover:text-white active:text-white hover:bg-blue-700 active:bg-blue-700 rounded-lg shadow-sm hover:shadow-md"
        >
          Go Back
        </a>
      </main>
